...
<head>
    ...
    <title>Login - Wallpaper Hub</title>
...
<body>
    <div class="login-container">
        ...
        <div class="login-tabs">
            <button type="button" class="tab-button active" onclick="switchTab('user')">
                <i class="fas fa-user"></i> User
            </button>
            <button type="button" class="tab-button" onclick="switchTab('admin')">
                ...
                <div class="form-group">
                    ...
                    <div class="password-wrapper">
                        <input 
                            ...
                            required
                        >
                        <button type="button" class="toggle-password" onclick="togglePassword('user-password')">
                            <i class="fas fa-eye" id="user-password-icon"></i>
                        </button>
                    </div>
                    @error('password')
                        <div class="error-message">{{ $message }}</div>
        ...
        <div id="admin" class="tab-content">
            ...
            <div class="register-link">
                New admin? <a href="{{ route('admin.register') }}">Register here</a>
            </div>
        </div>
    </div>
